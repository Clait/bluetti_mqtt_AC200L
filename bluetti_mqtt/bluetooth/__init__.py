...
from bluetti_mqtt.core import BluettiDevice, AC200L, AC200M, AC300, AC500, AC60, EP500, EP500P, EP600, EB3A
...
DEVICE_NAME_RE = re.compile(r'^(AC200L|AC200M|AC300|AC500|AC60|EP500P|EP500|EP600|EB3A)(\d+)$')
